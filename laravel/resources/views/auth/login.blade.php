                            ...
                            <div class="p-3">
                                ...
                                <div class="row gy-2">
                                    ...
                                    <div class="col-md-12 d-grid ">
                                        <button type="submit" class="btn btn-primary-gradient btn-wave"
                                            name="register"><a href="/admin/dashboard" class="text-light">Sign In</a>
                                        </button>
                                    </div>
                                </div>
                                <div class="text-center">
                                    <p class="fs-12 text-muted mt-4">Dont have an account? <a href="/register"
