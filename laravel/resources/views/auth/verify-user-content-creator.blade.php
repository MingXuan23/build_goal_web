            ...
            <div class="col-md-4">
                ...
                <div class="card custom-card">
                    <div class="card-body p-5">
                        <p class="h5 fw-semibold mb-2 text-center">Verify Your Identity Number</p>
                        <p class="mb-4 text-muted op-7 fw-normal text-center">Enter your identity number before proceed
                            to make sure you are the valid user</p>
                        <form action="{{ route('verifyUserContentCretor') }}" method="post">
                            @csrf
                            <div class="row ">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-floating">
                                                ...
                                                <label for="floatingInputprimary">Enter Identity Number</label>
                                                @error('icNo')
