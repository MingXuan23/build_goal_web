    ...
    <div class="container-lg">
        <div class="row justify-content-center align-items-center authentication authentication-basic h-100">
            <div class="col-md-4">
                ...
                <div class="alert alert-danger alert-dismissible d-flex align-items-center" role="alert">
                    <i class="bi bi-dash-circle-fill fs-4"></i>
                    <div class="ms-3"> {{ $errors->first() }} </div>
                    <button type="button" class="btn-close" data-bs-dismiss="alert"
                        aria-label="Close"></button>
                </div>
                @endif
                ...
                <div class="card custom-card">
                    <div class="card-body p-5">
                        ...
                        <p class="mb-4 text-muted op-7 fw-normal text-center">Enter the 6 digit code sent to the
                        ...
                        <form action="{{ route('verifyCode') }}" method="post">
                            ...
                            <div class="row ">
                                <div class="col-xl-12 mb-2">
                                    <div class="row">
                                        <div class="col-4 col-md-4 col-lg-4 col-sm-4 col-xl-4 mt-1 mb-1">
                                            <input type="text"
                                                class="form-control form-control-lg text-center code-input  @error('input1') is-invalid @enderror"
                                                id="one" maxlength="1" name="input1">
                                        </div>
                                        <div class="col-4 col-md-4 col-lg-4 col-sm-4 col-xl-4 mt-1 mb-1">
                                            <input type="text"
                                                class="form-control form-control-lg text-center code-input  @error('input2') is-invalid @enderror"
                                                id="two" maxlength="1" name="input2">
                                        </div>
                                        <div class="col-4 col-md-4 col-lg-4 col-sm-4 col-xl-4 mt-1 mb-1">
                                            <input type="text"
                                                class="form-control form-control-lg text-center code-input  @error('input3') is-invalid @enderror"
                                                id="three" maxlength="1" name="input3">
                                        </div>
                                        <div class="col-4 col-md-4 col-lg-4 col-sm-4 col-xl-4 mt-1 mb-1">
                                            <input type="text"
                                                class="form-control form-control-lg text-center code-input  @error('input4') is-invalid @enderror"
                                                id="four" maxlength="1" name="input4">
                                        </div>
                                        <div class="col-4 col-md-4 col-lg-4 col-sm-4 col-xl-4 mt-1 mb-1">
                                            <input type="text"
                                                class="form-control form-control-lg text-center code-input  @error('input5') is-invalid @enderror"
                                                id="five" maxlength="1" name="input5">
                                        </div>
                                        <div class="col-4 col-md-4 col-lg-4 col-sm-4 col-xl-4 mt-1 mb-1">
                                            <input type="text"
                                                class="form-control form-control-lg text-center code-input  @error('input6') is-invalid @enderror"
                                                id="six" maxlength="1" name="input6">
                                        </div>
                                    </div>

                                    <div class="form-check mt-2">
                                        <label class="form-check-label">
                                            Did not recieve a code ?<a href="/resend-code"
                                                class="text-primary fw-bold ms-2 d-inline-block text-underline"><u>Resend</u></a>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-xl-12 d-grid mt-2">
                                    <input type="submit" class="btn btn-lg btn-primary" value="verify"
                                        name="verify"></input>
                                </div>
                            </div>
                        </form>
                        ...
                        <div class="text-center">
                            <p class="fs-10 text-danger fw-semibold mt-3 mb-0"><sup><i
                                        class="ri-asterisk"></i></sup>Don't
                                share
