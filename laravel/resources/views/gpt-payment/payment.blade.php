                        ...
                        <div class="">
                            <div class="payment-body">
                                <div class="order-summary p-5">
                                    <div class="row mb-2">
                                        <div class="col-md-6">
                                            <h5 class=" fw-bold">PAYMENT CONFIRMATION <span class="text-success">(premimum)</span></h5>
                                        </div>
                                    ...
                                    <div class="detail-section">
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="price-tag me-5">RM {{ number_format($price) }}
                                            </div>
                                        </div>
                                    </div>
                                    <form action="{{ route('directpayIndex') }}" method="POST">
                                        @csrf
                                        <input type="hidden" name="gpt_token"
                                            value="{{ $data['uuid'] . '-' . preg_replace('/[^0-9]/', '', $data['time']) }}">
