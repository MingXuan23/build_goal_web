                ...
                <div class="col-xl-12">
                    <div class="card custom-card">
                        <div class="card-header">
                            <div class="card-title">List of Smart Contract</div>
                        </div>
                        <div class="card-body">
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            // Pastikan smart_contract_status_contract adalah 1
                            if (row.smart_contract_status_contract == 1 || row.smart_contract_status_contract == 0) {                           
                                return `
                            ...
                            else if(row.smart_contract_status_contract == '' || row.smart_contract_status_contract == null || row.smart_contract_status_contract == undefined){
                            // Jika status valid, tampilkan tombol
                                return '-';
                            }
                        }
                    },
