                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <p>Payment From&nbsp;&nbsp;&nbsp;&nbsp;: <span
                                                    class="fw-bold">{{ $data->user_name }}</span></p>
                                            <p>Phone Number&nbsp;&nbsp;&nbsp;: <span
                                                    class="fw-bold">{{ $data->user_phone }}</span></p>
                                            <p>Email&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
                                                <span class="fw-bold"> {{ $data->user_email }}</span></p>
                                        </div>
                                        <div class="col-md-5">
    ...
    <script>
        $(document).ready(function() {
            $('.data-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('showTransactionHistoryXbugAi') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        searchable: false,
