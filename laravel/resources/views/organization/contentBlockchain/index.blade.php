                            ...
                            <div class="p-0 ">
                                ...
                                <div id="validationResultSection">
                                    ...
                                    @if ($errorMessage)
                                        ...
                                        <!-- Tombol Back -->
                                        <a href="/organization/dashboard" class="btn btn-primary btn-back w-100 py-3">
                                            Back to Dashboard
                                        </a>
                                    @elseif ($redirect)
                                        ...
                                        <div class="initial-subtitle ">
                                            ...
                                            <span id="countdown" class="countdown">8</span>
                                            <span>seconds</span>
                                            <br>
                                        </div>
                                    @else
            ...
            const countdownTimer = setInterval(() => {
                ...
                if (countdownNumber <= 0) {
                    ...
                    if (xBugBlockchainUrl) {
                        window.location.href = xBugBlockchainUrl + '/protected/dashboard';
                    }
                }
            }, 1000);
