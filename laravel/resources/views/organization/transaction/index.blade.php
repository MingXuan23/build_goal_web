        ...
        <div class="container">
            ...
            <div class="card custom-card">
                <div class="card-header">
                    <div class="card-title">Transaction History For Promote Content</div>
                </div>
                <div class="card-body">
                        ...
                        <div class="p-4">
                            <div class="row">
                                <div class="col-md-5">
                                    ...
                                    <h6 class="mt-3 fw-bold d-flex align-items-center ">PROMOTION RECEIPT <span
    ...
    <script>
        $(document).ready(function() {
            $('.data-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('showTransactionHistoryPromoteContentOrg') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        searchable: false,
