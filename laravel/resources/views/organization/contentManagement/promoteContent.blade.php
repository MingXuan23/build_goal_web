                  ...
                  <form action="#" method="POST">
                     ...
                     <!-- <style>
                        ...
                        <div class="tags-input" id="tagsInput">
                           <input type="text" placeholder="Type to search locations...">
                        </div>
                        </div>
                        <script>
                        class TagsInput {
                           constructor(element) {
                              ...
                              // Sample data - Malaysian states
                              this.availableItems = [
                                    'Melaka', 'Johor', 'Penang', 'Selangor', 'Kedah',
                                    'Perak', 'Pahang', 'Terengganu', 'Kelantan', 'Perlis',
                                    'Sabah', 'Sarawak', 'Negeri Sembilan'
                              ];
