      ...
      <div class="card">
         ...
         <div class="card-body">
            <form action="{{ route('uploadMicroLearning') }}" method="POST" enctype="multipart/form-data">
               ...
               <button type="button" id="showSectionFormButton" class="btn btn-primary mt-3" onclick="showSectionForm()">Add Section</button>
               ...
               <div id="sectionInput" class="mt-3" style="display: none;">
                  ...
                  <button type="button" class="btn btn-success mt-3" onclick="addSection()">Add this section</button>
               </div>
