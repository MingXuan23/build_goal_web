        ...
        <div class="container">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('uploadMicroLearning') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div id="mainButtons">
                            <button type="button" class="btn btn-primary" onclick="showSectionInput()">Add Section
                                Here</button>
                            <button type="button" class="btn btn-primary" onclick="generatePreview()">Generate
                                Preview</button>
                        </div>
            ...
            <div id="previewCard" class="card" style="display: none;">
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-8">
                            <button class="btn btn-primary mt-3" onclick="returnToForm()">Back to Form</button>
                            <!-- Added button to go back to the form -->
                        </div>
                        <div class="col-md-2 text-end"></div>
                        <div class="col-md-2">
                        </div>
