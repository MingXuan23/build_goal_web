    ...
    <div class="main-content app-content">
        <div class="container">
            <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                <h1 class="page-title fw-semibold fs-18 mb-0">Content User (Enrolled)</h1>
            ...
            <div class="card custom-card">
                <div class="card-header d-flex justify-content-between">
                    <div class="card-title">List Content User (Enrolled)</div>
                    <button class="btn btn-primary " data-bs-toggle="modal" data-bs-target="#viewAllContentClickedViewed">
                        List Paid Content Enrollment for xBug Stand
                    </button>
                </div>
                <div class="card-body">
            ...
            <div class="modal-dialog modal-dialog-centered text-center modal-lg modal-dialog-scrollable">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">Enrollment for - {{ strtoupper($data->name) }}</h6>
    ...
    <script>
        $(document).ready(function() {
            var table = $('.data-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('showContentUserEnrolledOrganization') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        searchable: false
            ...
            $(document).on('click', '.btn-info-transparent', function() {
                ...
                $.ajax({
                    url: '/organization/content-detail/' + contentId + '/' + interactionType,
                    method: 'GET',
