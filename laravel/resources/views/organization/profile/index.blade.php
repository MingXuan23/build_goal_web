               ...
               <div class="row">
                  ...
                  <div class="col-md-12 mb-3">
                     <div class="alert alert-solid-danger alert-dismissible fade show" role="alert">
                        <i class="bi bi-exclamation-lg"></i>Your account has not been verified because you have not completed the eKYC process. Go to<span class="fw-bold text-light"> e-kyc Detail</span> to complete your eKYC..
                     </div>
                  </div>
                  @endif
                  <div class="col-md-12">
