<aside class="app-sidebar sticky" id="sidebar">
    ...
    <!-- Start::main-sidebar -->
    <div class="main-sidebar" id="sidebar-scroll"  data-intro="Hi, Welcome to xBUG Dashboard Panel! This is the main part of your sidebar, containing the navigation menu."
    data-step="2">
        ...
        <nav class="main-menu-container nav nav-pills flex-column sub-open">
            ...
            <ul class="main-menu">
                ...
                <li class="slide" data-intro="This menu directs you to the main Dashboard." data-step="3">
                ...
                @if (Auth::user()->ekyc_status === 1)
                    ...
                    <li class="slide has-sub"
                        data-intro="Here you can manage content, such as viewing or applying content." data-step="4">
                    ...
                    <li class="slide has-sub"
                        ...
                        <ul class="slide-menu child1">
                            ...
                            <li class="slide">
                                <a href="/organization/content-user-enrolled" class="side-menu__item">Enrolled
                                    Content</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="slide has-sub"
                        ...
                        <ul class="slide-menu child1">
                            <li class="slide">
                                <a href="/organization/transaction-history-promote-content"
                    ...
                    <li class="slide has-sub" data-intro="Menu to display your latest notifications." data-step="7">
                        <a href="javascript:void(0);" class="side-menu__item ">
                    ...
                    <li class="slide has-sub" data-intro="xBUG Ai is a premium feature for AI chatbot." data-step="8">
                        <a href="javascript:void(0);" class="side-menu__item ">
