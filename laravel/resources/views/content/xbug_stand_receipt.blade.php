                            ...
                            <div class="card-body">
                                <div class="order-summary p-5">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        ...
                                        <span class="ms-1 mt-3">Provided by <span
                                    ...
                                    <div class="detail-section mt-3">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <p><strong>Number of
                                                        Stand:</strong><br>{{ number_format($cp_id->number_of_card, 0) }}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="detail-section mt-3">
                                        <div class="row ">
                                            @if (isset($content_cards) && count($content_cards) > 0)
                                                ...
                                                @endforeach
                                            @else
                                                <p>We are preparing your xBUG stand and the tracking id will available
                                                    soon.</p>
                                            @endif
                                        </div>
                                    </div>
