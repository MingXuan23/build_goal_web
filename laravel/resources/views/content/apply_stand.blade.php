                        ...
                        <div class="">
                            <div class="payment-body">
                                <div class="order-summary p-5">
                                    <div class="row mb-2">
                                        <div class="col-md-6">
                                            <h5 class=" fw-bold">PAYMENT CONFIRMATION</h5>
                                        </div>
                                        <div class="col-md-6 d-flex justify-content-end">
                                            <div class="secure-badge">
                                                <div class="text-center">
                                                    <img src="https://directpay.my/assets/images/logo.jpg"
                                                        class="img-fluid rounded" width="26" height="26">
                                                </div>
                                                <span class="fw-bold">Provided by <span class="fw-bold text-primary">Direct
                                                        Pay</span></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="detail-section mt-5">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <span class="me-3">{{ $content->name }}</span>
                                        </div>

                                    </div>

                                    <div class="detail-section d-flex justify-content-between align-items-center">
                                        <!-- Number of xBUG Stands -->
                                        <p><strong>Number Of Xbug Stands Ordered: </strong></p>
                                        <h5 class="me-3">{{ $stand_id->number_of_card }}</h5>
                                    </div>

                                    <div class="detail-section">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <h6 class=" m-0 fw-bold">TOTAL AMOUNT</h6>
                                            <div class="price-tag">RM {{ number_format($stand_id->promotion_price, 2) }}
                                            </div>
                                        </div>
                                    </div>
                                    <form action="{{ route('directpayIndex') }}" method="POST">
                                        @csrf
                                        <input type="hidden" name="stand_token"
                                            value="{{ $stand_id->id . '-' . preg_replace('/[^0-9]/', '', $stand_id->updated_at) }}">

                                        <div class="text-center mt-3 d-flex justify-content-end">
                                            <button type="submit" class="btn confirm-button btn-success btn-sm px-3 py-2">
