                                                    ...
                                                    <ul class="nav nav-tabs nav-tabs-header mb-0 d-sm-flex d-block d-flex p-2 align-items-center justify-content-start"
                                                        ...
                                                        <li class="nav-item m-1">
                                                            <a class="nav-link" id="ekyc-tab" data-bs-toggle="tab"
                                                                ...
                                                                aria-selected="false">e-KYC Detail</a>
                                                        </li>
                                                        <li class="nav-item m-1">
                                ...
                                @if (Auth::user()->ekyc_status === 0)
                                    <div class="col-md-12 mb-3">
                                        <div class="alert alert-solid-danger alert-dismissible fade show" role="alert">
                                            ...
                                            you have not completed the eKYC process. <a href=""
                                                class="fw-bold text-light">Click here</a> to complete your eKYC..
                                        </div>
                                    </div>
                                @endif
                                                ...
                                                <div class="col-md-12">
                                                    <div class="card custom-card overflow-hidden">
                                                        <div class="card-body p-0">
                                                            ...
                                                            <div class="p-4 border-bottom border-block-end-dashed">
                                                                <form action="{{ route('updatePasswordContentCreator') }}"
                                                                    method="post">
                                                                    @csrf
                                                                    <div class="col-md-12">
                                                                        <div class="row">
