...
<body data-pc-preset="preset-1" data-pc-sidebar-caption="true" data-pc-layout="vertical" data-pc-direction="ltr"
    ...
    <nav class="navbar navbar-expand-md navbar-light default shadow shadow-sm">
        <div class="container d-flex justify-content-center">
            ...
            <span class="fw-bold text-primary" style="color: #0b0d86">xBug</span>
        </div>
    </nav>
    <!-- Page 1 Start -->
            ...
            <div class="row justify-content-center align-items-center">
                ...
                <center>
                    <div class="loading " id="loading" style="display: none; margin-bottom: 12rem ;">
                        ...
                        <p class="fw-bold text-center">Please Wait, We're connecting to xBUG e-KYC Server For Verifying
                            Face...</p>
                    </div>
                </center>
                <div class="row justify-content-center align-items-center">
    ...
    <script>
        // Initialize filename globally
        const urlParams = new URLSearchParams(window.location.search);
        filename = urlParams.get("id");

        // Hide page-2 initially
        $('.page-2').hide();

        // Handle button click to switch pages
        ...
        // Start video on DOMContentLoaded
        ...
        snap.addEventListener("click", function() {
            // Show loading and hide video and buttons
            ...
            fetch("{{ env('API_EKYC_URL') }}/process-face", {
                ...
                .catch((error) => {
                    ...
                    Swal.fire({
                        icon: 'error',
                        title: 'ERROR SENDING IMAGE TO SERVER. CONTACT US BY EMAIL AT [help-center@xbug.online] FOR INFORMATION OR REPORT',
                        allowOutsideClick: false, // Prevent closing by clicking outside
                        allowEscapeKey: false, // Prevent closing by pressing Esc
                        customClass: {
                            title: 'custom-title',
